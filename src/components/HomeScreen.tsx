...
export default function HomeScreen() {
    return (
        <section className='section-padding relative flex min-w-full bg-zinc-100 justify-evenly flex-wrap max-md:justify-center px-40 max-xl:px-0'>
            <article className='justify-center flex flex-col max-w-[40vw] max-md:min-w-full gap-4'>
                ...
                <div>
                    <Button variant="contained" className='bg-[linear-gradient(93deg,_#cc186e_-7%,#8b1717_146%)] pt-3 pb-3'>Agendar agora</Button>
                </div>
            </article>
